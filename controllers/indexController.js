...
// var rClient = new restClient({
//   proxy:{
//             host:globalVariable.proxy.user,
//             port: globalVariable.proxy.port,
//             user:globalVariable.proxy.user,
//             password:globalVariable.proxy.password
//         }
// });

exports.index = function(req, res) {
    return res.render('index', { title: 'Tugas Akhir Dalam Jaringan', copyright: globalVariable.copyright })
}
...
exports.masuk = function(req, res) {
  ...
  rClient.post(globalVariable.general_url+'/masuk', args, function (data, response) {
...
exports.daftar = function(req, res) {
    return res.render('daftar/index', { title: 'Daftar', copyright: globalVariable.copyright })
}

exports.daftar_mahasiswa = function(req, res) {
    return res.render('daftar/mahasiswa', { title: 'Daftar Mahasiswa', copyright: globalVariable.copyright })
}

exports.daftar_dosen = function(req, res) {
    return res.render('daftar/dosen', { title: 'Daftar Dosen', copyright: globalVariable.copyright })
}
...
exports.daftar_mahasiswa_proses = function(req, res) {
    ...
    rClient.post(globalVariable.general_url+'/daftar/proses/mahasiswa', args, function (data, response) {
...
exports.daftar_dosen_proses = function(req, res) {
    ...
    rClient.post(globalVariable.general_url+'/daftar/proses/dosen', args, function (data, response) {
...
exports.keluar = function(req, res) {
    ...
    rClient.post(globalVariable.general_url+'/keluar', args, function (data, response) {
...
exports.tentang = function(req, res) {
    return res.render('tentang', { title: 'Tentang', copyright: globalVariable.copyright })
}

exports.lihat_judul = function(req, res) {
    return res.render('lihat_judul', { title: 'Lihat Judul TA', copyright: globalVariable.copyright })
}

exports.panduan = function(req, res) {
    return res.render('panduan', { title: 'Panduan', copyright: globalVariable.copyright })
}
...
exports.bagikan_kelompok = function (req, res) {
    return res.render('anggota/mahasiswa/kelompok/bagikan', { title: 'TA0000000', copyright: globalVariable.copyright })
}

exports.public_profil = function (req, res) {
    return res.render('public_profil', { title: 'Username', copyright: globalVariable.copyright })
}
